...
namespace Gostica
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "_22_107k_06_gostinicaaa_DataSet.бронирование". При необходимости она может быть перемещена или удалена.
            this.бронированиеTableAdapter.Fill(this._22_107k_06_gostinicaaa_DataSet.бронирование);
        ...
        private void бронированиеBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this._22_107k_06_gostinicaaa_DataSet);
